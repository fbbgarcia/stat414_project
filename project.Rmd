...
# matrix plot
pairs(alzheimers[, c("cenLogDALYs", 
                     "cenYear",
                     "cenAlcohol", 
                     "cenHypertension", 
                     "cenInactivity",
...
modelCountryOLS <- lm(cenLogDALYs ~ country, data = alzheimers)
...
model0Country <- lmer(cenLogDALYs ~ (1 | country), data = alzheimers)
...
model1a <- lmer(cenLogDALYs ~ cenYear + cenAlcohol + cenObesity + (1 | country), data = alzheimers)
summary(model1a)
anova(model0Country, model1a)

# adding Region (Level 2 variable)
model1b <- lmer(cenLogDALYs ~ cenYear + cenAlcohol + cenObesity + region + (1 | country), data = alzheimers)
summary(model1b)
anova(model1a, model1b)

# adding interaction between Obesity and Region
model1c <- lmer(cenLogDALYs ~ cenYear + cenAlcohol + cenObesity*region + (1 | country), data = alzheimers)
summary(model1c)
anova(model1b, model1c)

# adding interaction between Alcohol and Region
# FINAL MODEL
model1d <- lmer(cenLogDALYs ~ cenYear + cenAlcohol*region + cenObesity*region + (1 | country), data = alzheimers)
summary(model1d)
