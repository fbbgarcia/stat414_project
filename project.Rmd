...
# notice correlation between Obesity and Overweight, Inactivity, and Hypertension
...
alzheimers |>
  ggplot() +
    ...
    theme_minimal() +
    labs(title = "How does a country's burden of dementias relate to ",
         x = "Alcohol Consumption",
         y = "DALY",
         colour = "Region", 
         linetype = "Region") 

# scatter plots of DALY by Alcohol seperated by Region
alzheimers |>
  ggplot() +
    geom_point(aes(x = alcohol, y = DALY, colour = region),
...
alzheimers |>
  ggplot() +
    ...
    scale_color_manual(values = region_colors) + 
    theme_minimal() +
    labs(title = "DALY of Dementias by Obesity",
         x = "Obesity",
         y = "DALY",
         colour = "Region", 
         linetype = "Region") 
...
alzheimers |>
  ggplot() +
    geom_point(aes(x = region, y = DALY, color = region), show.legend = FALSE) +
    scale_color_manual(values = region_colors) +
    theme_minimal() +
    labs(title = "DALY of Dementias by Region",
         x = "Region",
         y = "DALY") 
...
plot(predicted_Ainteraction) +
  labs(title = "Interaction between Obesity and Region",
       x = "Centered Obesity",
       y = "Predicted DALY") +
  theme_minimal()
...
plot(predicted_Ainteraction) +
  labs(title = "Interaction between Alcohol and Region",
       x = "Centered Alcohol",
       y = "Predicted DALY") +
  theme_minimal()
...
plot(predicted_Ointeraction) +
  labs(title = "Interaction between cenObesity and Region",
       x = "Centered Obesity",
       y = "Predicted DALY") +
  theme_minimal()
